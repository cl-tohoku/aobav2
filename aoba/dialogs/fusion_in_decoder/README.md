...
- This directory is copied from [cl-tohoku/open-domain-qa](https://github.com/cl-tohoku/open-domain-qa/tree/develop/generators/fusion_in_decoder)
  - The original repository is [facebookresearch/FiD](https://github.com/facebookresearch/FiD)
