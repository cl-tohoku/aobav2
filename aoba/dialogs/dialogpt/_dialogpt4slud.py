...
from transformers import T5Tokenizer, AutoModelForCausalLM, AutoTokenizer, AutoConfig
...
class DialoGptModel(object):
    ...
    def add_parser(cls, parser):
        dgpt = parser.add_argument_group('Group of DialoGPT')
        dgpt.add_argument('--dgpt_model', type=str, default=f'/work02/SLUD2021/models/dialogpt/GP2-pretrain-step-300000.pkl')
        dgpt.add_argument('--dgpt_config', type=str, default=f'/work02/SLUD2021/models/dialogpt/config.json')
        dgpt.add_argument('--dgpt_toker', type=str, default=f'/work02/SLUD2021/models/dialogpt/tokenizer')
        dgpt.add_argument("--dgpt_max_history", type=int, default=1)
        return parser
